 ...
 */
  ...
  * ===============================================================
  */
#ifndef FE_NK_GLFW_GL4_H_
#define FE_NK_GLFW_GL4_H_
...
NK_API struct nk_context* nk_glfw3_gl4_init(GLFWwindow* win, enum nk_glfw_init_state init_state, int max_vertex_buffer, int max_element_buffer);
NK_API void                 nk_glfw3_gl4_shutdown(void);
NK_API void                 nk_glfw3_gl4_font_stash_begin(struct nk_font_atlas** atlas);
NK_API void                 nk_glfw3_gl4_font_stash_end(void);
NK_API void                 nk_glfw3_gl4_new_frame(void);
NK_API void                 nk_glfw3_gl4_render(enum nk_anti_aliasing);

NK_API void                 nk_glfw3_gl4_device_destroy(void);
NK_API void                 nk_glfw3_gl4_device_create(void);

NK_API void                 nk_glfw3_gl4_char_callback(GLFWwindow* win, unsigned int codepoint);
NK_API void                 nk_gflw3_gl4_scroll_callback(GLFWwindow* win, double xoff, double yoff);
NK_API void                 nk_glfw3_gl4_mouse_button_callback(GLFWwindow* win, int button, int action, int mods);

NK_API GLuint               nk_glfw3_gl4_get_tex_ogl_id(int tex_index);
NK_API GLuint64             nk_glfw3_gl4_get_tex_ogl_handle(int tex_index);
NK_API int                  nk_glfw3_gl4_create_texture(const void* image, int width, int height);
NK_API void                 nk_glfw3_gl4_destroy_texture(int tex_index);
...
nk_glfw3_gl4_device_create()
{
...

    {
        ...
        GLuint vp = offsetof(struct nk_glfw_vertex, position);
        GLuint vt = offsetof(struct nk_glfw_vertex, uv);
        GLuint vc = offsetof(struct nk_glfw_vertex, col);
...
NK_API GLuint
nk_glfw3_gl4_get_tex_ogl_id(int tex_index)
{
    struct nk_glfw_device* dev = &glfw.ogl;
...
NK_API GLuint64
nk_glfw3_gl4_get_tex_ogl_handle(int tex_index)
{
    struct nk_glfw_device* dev = &glfw.ogl;
    assert(tex_index >= 0 && tex_index < NK_GLFW_MAX_TEXTURES);
...
NK_API int
nk_glfw3_gl4_create_texture(const void* image, int width, int height)
{
    GLuint id;
...
NK_API void
nk_glfw3_gl4_destroy_texture(int tex_index)
{
    struct nk_glfw_device* dev = &glfw.ogl;
    GLuint id = nk_glfw3_gl4_get_tex_ogl_id(tex_index);
    if (id == 0) return;

    {
        GLuint64 handle = nk_glfw3_gl4_get_tex_ogl_handle(tex_index);
...
{
    struct nk_glfw_device* dev = &glfw.ogl;
    dev->font_tex_index = nk_glfw3_gl4_create_texture(image, width, height);
}

NK_API void
nk_glfw3_gl4_device_destroy(void)
{
    int i = 0;
    struct nk_glfw_device* dev = &glfw.ogl;
    ...
    nk_glfw3_gl4_destroy_texture(dev->font_tex_index);

    for (i = 0; i < NK_GLFW_MAX_TEXTURES; i++)
        nk_glfw3_gl4_destroy_texture(i);
...
NK_API void
nk_glfw3_gl4_render(enum nk_anti_aliasing AA)
{
    struct nk_glfw_device* dev = &glfw.ogl;
    ...
    glViewport(0, 0, (GLsizei)glfw.display_width, (GLsizei)glfw.display_height);
    {
        ...
        nk_draw_foreach(cmd, &glfw.ctx, &dev->cmds)
        {
            ...
            tex_handle = nk_glfw3_gl4_get_tex_ogl_handle(tex_index);
...
NK_API void
nk_glfw3_gl4_char_callback(GLFWwindow* win, unsigned int codepoint)
{
    (void)win;
...
NK_API void
nk_gflw3_gl4_scroll_callback(GLFWwindow* win, double xoff, double yoff)
{
    (void)win; (void)xoff;
...
NK_API void
nk_glfw3_gl4_mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    double x, y;
    NK_UNUSED(mods);
...
NK_API struct nk_context* nk_glfw3_gl4_init(GLFWwindow* win, enum nk_glfw_init_state init_state,
    int max_vertex_buffer, int max_element_buffer)
{
    glfw.win = win;
    if (init_state == NK_GLFW3_INSTALL_CALLBACKS) {
        glfwSetScrollCallback(win, nk_gflw3_gl4_scroll_callback);
        glfwSetCharCallback(win, nk_glfw3_gl4_char_callback);
        glfwSetMouseButtonCallback(win, nk_glfw3_gl4_mouse_button_callback);
    }
...
NK_API void
nk_glfw3_gl4_font_stash_begin(struct nk_font_atlas** atlas)
{
...
NK_API void
nk_glfw3_gl4_font_stash_end(void)
{
...
NK_API
void nk_glfw3_gl4_shutdown(void)
{
    nk_font_atlas_clear(&glfw.atlas);
    nk_free(&glfw.ctx);
    nk_glfw3_gl4_device_destroy();
