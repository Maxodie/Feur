...
set_target_properties("Nuklear" PROPERTIES
    OUTPUT_NAME "Nuklear"
    ARCHIVE_OUTPUT_DIRECTORY "${FE_OUTPUT_TARGET}/Nuklear"
    LIBRARY_OUTPUT_DIRECTORY "${FE_OUTPUT_TARGET}/Nuklear"
    RUNTIME_OUTPUT_DIRECTORY "${FE_OUTPUT_TARGET}/Nuklear"
)

target_include_directories("Nuklear" PRIVATE
    ${CMAKE_CURRENT_SOURCE_DIR}/FeurEngine/vendor/nuklear/Nuklear
)
